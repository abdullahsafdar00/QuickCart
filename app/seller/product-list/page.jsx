        ...
        <table className="min-w-full hidden sm:table bg-white border border-gray-200 rounded-md">
          ...
          <tbody className="text-sm text-gray-600">
            ...
            <div className="flex items-center justify-center gap-4 mt-5 w-full">
                <button  onClick={() => setIsOpen(false)} type="button" className="w-full md:w-36 h-10 rounded-md border border-gray-300 bg-white text-gray-600 font-medium text-sm hover:bg-gray-100 active:scale-95 transition">
                    Cancel
                </button>
                <button onClick={() => handleDelete(product._id)} type="button" className="w-full md:w-36 h-10 rounded-md text-white bg-red-600 font-medium text-sm hover:bg-red-700 active:scale-95 transition">
                    Confirm
                </button>
            </div>
        </div>
